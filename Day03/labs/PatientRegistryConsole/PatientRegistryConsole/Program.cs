...
namespace PatientRegistryConsole
{
    class Program
    {
        ...
        static List<string> updateHistory = new List<string>();
        ...
        static void UpdatePatient()
        {
            ...
            else
            {
                ...
                updateHistory.Add(
                    $"Old Name: {oldName}, New Name: {newName}, Updated At: {DateTime.Now}"
                );
        ...
        static void DisplayUpdateHistory()
        {
            foreach (string history in updateHistory)
            {
